...
const {patientGet,patientPost,patientUpdate,patientDelete,patientGetData,patientByDate} =require('../../Controller/hptl_patient/patient')
...
patient.get('/hptl/patient/date',patientByDate);
